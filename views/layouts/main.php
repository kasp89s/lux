...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    ...
    <?php if (!Yii::$app->user->isGuest):?>
        <nav class="my-2 my-md-0 mr-md-3">
            <span>Привет <b><i><?= Yii::$app->user->identity->username?></i></b></span>
            <a class="p-2 text-dark" href="/site/add">Добавить</a>
            <a class="p-2 text-dark" href="/site/favorites">Избранное</a>
            <a class="p-2 text-dark" href="/site/logout">Выйти</a>
        </nav>
    <?php else: ?>
        <a class="btn btn-outline-primary" href="/site/login">Войти</a>
    <?php endif;?>
</div>
<!--<main role="main">-->
